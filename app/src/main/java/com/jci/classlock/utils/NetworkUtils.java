...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        GlobalApplication.getInstance().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) GlobalApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) GlobalApplication.getInstance().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) GlobalApplication.getInstance()
