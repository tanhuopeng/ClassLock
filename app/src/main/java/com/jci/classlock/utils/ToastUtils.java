...
public final class ToastUtils {
    ...
    private static int yOffset    = (int) (64 * GlobalApplication.getInstance().getResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(GlobalApplication.getInstance().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(GlobalApplication.getInstance().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(GlobalApplication.getInstance(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(GlobalApplication.getInstance());
                sToast.setView(view);
